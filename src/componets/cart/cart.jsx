  ...
  const navigate = useNavigate()
    ...
    const RemoveItem =async(pid) =>{
          ...
          const res = await axios({
            url:`https://proyectofinalback-production-b4d4.up.railway.app/api/carts/${cid}/product/${pid}`,
            method: 'DELETE',
    ...
    const ClearCart =async() =>{
        const res = await axios({
        url:`https://proyectofinalback-production-b4d4.up.railway.app/api/carts/${cid}`,
        method: 'DELETE',
        withCredentials: true,
      })
        const data = res.data
          ...
          <span className="col-2 ">Eliminar</span>
            ...
            <div className="descripcion row mt-4">
              <div className="col-12 d-flex justify-content-between">
                ...
                <Link to="/products"  type="button" className="btn btn-primary m-2" style={{ textDecoration: 'none'}}>Seguir Agregando</Link>
                <span>
